...
int main (int argc,char *argv[]) {
   ...
   constexpr fc::scalar uNB = -3, uNM = -2, uNS = -1, uZO = 0, uPS = 1, uPM = 2, uPB = 3; 
    ...
    std::vector<fc::scalar> u_mf_paras {uNB,uNB,uNM, uNB,uNM,uNS, uNM,uNS,uZO, uNS,uZO,uPS, uZO,uPS,uPM, uPS,uPM,uPB, uPM,uPB,uPB};
    ...
    fc::scalar Kp_u = 150.0;
    fc::scalar Kp_e = Kp_u/200;
    fzc->setParam_K(Kp_e, 0.1, Kp_u);
    fzc->showInfo();
